...
static String color_resources[] = {
  "*XmLabel*fontList:   		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmLabelGadget*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmScale*fontList:   		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmBulletinBoard*labelFontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*optionmenu.XmLabelGadget*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmPushButton*fontList:		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmPushButtonGadget*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmToggleButton*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmToggleButtonGadget*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*optionmenu*fontList:		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmIconGadget*fontList:		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmBulletinBoard*buttonFontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*menubar*fontList:   		-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmPushButton*fontList:  -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmLabelGadget*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmPushButtonGadget*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmCascadeButton*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmCascadeButtonGadget*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmCascadeButton*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmCascadeButtonGadget*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmToggleButton*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmMenuShell*XmToggleButtonGadget*fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*pulldownmenu*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmList*fontList:	-*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmText.fontList:      -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*XmTextField.fontList: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  ...
  "*TitleFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*ItalicFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*BoldFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*FixedFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header1Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header2Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header3Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header4Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header5Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*Header6Font: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*AddressFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*PlainFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*ListingFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*SupSubFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*MeterFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*ToolbarFont: -*-unifont-*-*-*-*-17-*-*-*-*-*-iso10646-*",
  "*AnchorUnderlines:                   1",
